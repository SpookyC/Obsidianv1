...
// src/searchView.ts
var ESearchResultsRenderingTypes;
(function(ESearchResultsRenderingTypes3) {
  ESearchResultsRenderingTypes3["TABLE"] = "TABLE";
  ESearchResultsRenderingTypes3["LIST"] = "LIST";
})(ESearchResultsRenderingTypes || (ESearchResultsRenderingTypes = {}));
...
var ESearchColumnsTypes;
(function(ESearchColumnsTypes2) {
...
})(ESearchColumnsTypes || (ESearchColumnsTypes = {}));
var SEARCH_COLUMNS_DESCRIPTION = {
  ...
  [ESearchColumnsTypes.AGGREGATE_TIME_ESTIMATED]: "#\u{1F551}Estimated",
  [ESearchColumnsTypes.AGGREGATE_TIME_ORIGINAL_ESTIMATE]: "#\u{1F551}Original Estimate",
  [ESearchColumnsTypes.AGGREGATE_TIME_SPENT]: "#\u{1F551}Spent",
  ...
  [ESearchColumnsTypes.TIME_ESTIMATE]: "\u{1F551}Estimate",
  [ESearchColumnsTypes.TIME_ORIGINAL_ESTIMATE]: "\u{1F551}Original Estimate",
  [ESearchColumnsTypes.TIME_SPENT]: "\u{1F551}Spent",
...
// src/settings.ts
var EAuthenticationTypes;
(function(EAuthenticationTypes2) {
  EAuthenticationTypes2["OPEN"] = "OPEN";
  EAuthenticationTypes2["BASIC"] = "BASIC";
  EAuthenticationTypes2["BEARER_TOKEN"] = "BEARER_TOKEN";
})(EAuthenticationTypes || (EAuthenticationTypes = {}));
...
var JiraIssueSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  loadSettings() {
    return __async(this, null, function* () {
      this._data = Object.assign({}, DEFAULT_SETTINGS, yield this._plugin.loadData());
      this._data.statusColorCache = DEFAULT_SETTINGS.statusColorCache;
    });
  }
  saveSettings() {
    return __async(this, null, function* () {
      yield this._plugin.saveData(this._data);
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Host").setDesc("Hostname of your company Jira server.").addText((text) => text.setPlaceholder("Example: " + DEFAULT_SETTINGS.host).setValue(this._data.host).onChange((value) => __async(this, null, function* () {
      this._data.host = value;
      yield this.saveSettings();
    })));
    new import_obsidian.Setting(containerEl).setName("Authentication type").setDesc("Select how the plugin should authenticate in your Jira server.").addDropdown((dropdown) => dropdown.addOptions(AUTHENTICATION_TYPE_DESCRIPTION).setValue(this._data.authenticationType).onChange((value) => __async(this, null, function* () {
      this._data.authenticationType = value;
      yield this.saveSettings();
      this.display();
    })));
    if (this._data.authenticationType === EAuthenticationTypes.BASIC) {
      new import_obsidian.Setting(containerEl).setName("Username").setDesc("Username to access your Jira account using HTTP basic authentication.").addText((text) => text.setValue(this._data.username).onChange((value) => __async(this, null, function* () {
        this._data.username = value;
        yield this.saveSettings();
      })));
      new import_obsidian.Setting(containerEl).setName("Password").setDesc("Password to access your Jira account using HTTP basic authentication.").addText((text) => text.setValue(DEFAULT_SETTINGS.password).onChange((value) => __async(this, null, function* () {
        this._data.password = value;
        yield this.saveSettings();
      })));
    }
    if (this._data.authenticationType === EAuthenticationTypes.BEARER_TOKEN) {
      new import_obsidian.Setting(containerEl).setName("Bearer token").setDesc("Token to access your Jira account using OAuth2 Bearer token authentication.").addText((text) => text.setValue(this._data.bareToken).onChange((value) => __async(this, null, function* () {
        this._data.bareToken = value;
        yield this.saveSettings();
      })));
    }
    containerEl.createEl("h2", { text: "Cache" });
    new import_obsidian.Setting(containerEl).setName("Cache time").setDesc("Time before the cached issue status expires. A low value will refresh the data very often but do a lot of request to the server.").addText((text) => text.setPlaceholder("Example: 15m, 24h, 5s").setValue(this._data.cacheTime).onChange((value) => __async(this, null, function* () {
      this._data.cacheTime = value;
      yield this.saveSettings();
    })));
    containerEl.createEl("h2", { text: "Rendering" });
    new import_obsidian.Setting(containerEl).setName("Default search results limit").setDesc("Maximum number of search results to retrieve when using jira-search without specifying a limit.").addText((text) => text.setValue(this._data.searchResultsLimit.toString()).onChange((value) => __async(this, null, function* () {
      this._data.searchResultsLimit = parseInt(value) || DEFAULT_SETTINGS.searchResultsLimit;
      yield this.saveSettings();
    })));
    new import_obsidian.Setting(containerEl).setName("Dark mode").addToggle((toggle) => toggle.setValue(this._data.darkMode).onChange((value) => __async(this, null, function* () {
      this._data.darkMode = value;
      yield this.saveSettings();
    })));
    containerEl.createEl("h2", { text: "Search columns" });
    const desc = document.createDocumentFragment();
    desc.append("Columns to display in the jira-search table visualization.");
    new import_obsidian.Setting(containerEl).setDesc(desc);
    this._data.searchColumns.forEach((column, index) => {
      const setting = new import_obsidian.Setting(containerEl).addDropdown((dropdown) => dropdown.addOptions(SEARCH_COLUMNS_DESCRIPTION).setValue(column.type).onChange((value) => __async(this, null, function* () {
        this._data.searchColumns[index].type = value;
        yield this.saveSettings();
        this.display();
      })).selectEl.addClass("flex-grow-1"));
      setting.addExtraButton((button) => button.setIcon(this._data.searchColumns[index].compact ? "compress-glyph" : "enlarge-glyph").setTooltip(this._data.searchColumns[index].compact ? "Compact" : "Full width").onClick(() => __async(this, null, function* () {
        this._data.searchColumns[index].compact = !this._data.searchColumns[index].compact;
        yield this.saveSettings();
        this.display();
      })));
      setting.addExtraButton((button) => button.setIcon("up-chevron-glyph").setTooltip("Move up").setDisabled(index === 0).onClick(() => __async(this, null, function* () {
      ...
      setting.addExtraButton((button) => button.setIcon("down-chevron-glyph").setTooltip("Move down").setDisabled(index === this._data.searchColumns.length - 1).onClick(() => __async(this, null, function* () {
        const tmp = this._data.searchColumns[index];
        this._data.searchColumns[index] = this._data.searchColumns[index + 1];
        this._data.searchColumns[index + 1] = tmp;
        yield this.saveSettings();
      ...
      setting.addExtraButton((button) => button.setIcon("trash").setTooltip("Delete").onClick(() => __async(this, null, function* () {
    ...
    const searchColumnsButtons = new import_obsidian.Setting(containerEl);
    searchColumnsButtons.addButton((button) => button.setButtonText("Add Column").setCta().onClick((value) => __async(this, null, function* () {
      this._data.searchColumns.push({ type: ESearchColumnsTypes.KEY, compact: false });
      yield this.saveSettings();
      this.display();
    })));
    searchColumnsButtons.addButton((button) => button.setButtonText("Reset columns").setWarning().onClick((value) => __async(this, null, function* () {
...
var JiraClient = class {
  ...
  buildUrl(path, queryParameters = null) {
  ...
  sendRequest(options) {
    return __async(this, null, function* () {
      let response;
      try {
        response = yield (0, import_obsidian2.requestUrl)(options);
      } catch (e) {
...
var renderTableColumn = (columns, issue, row, processor) => {
...
// src/processor.ts
var COMMENT_REGEX = /^\s*#/;
var ISSUE_REGEX = /^\s*([A-Z0-9]+-[0-9]+)\s*$/i;
var ISSUE_LINK_REGEX = /\/([A-Z0-9]+-[0-9]+)\s*$/i;
...
var JiraIssueProcessor2 = class {
  constructor(settings, client, cache, vault) {
    this._settings = settings;
    this._client = client;
    this._cache = cache;
    this._vault = vault;
  }
  issueFence(source, el, ctx) {
    return __async(this, null, function* () {
      const renderedItems = {};
  ...
  searchResultsFence(source, el, ctx) {
    return __async(this, null, function* () {
      try {
        const searchView = new SearchView().fromString(source);
        let searchResults = this._cache.get(searchView.query + searchView.limit);
        if (!searchResults) {
          this.renderLoadingItem("View in browser", this.searchUrl(searchView.query));
          this._client.getSearchResults(searchView.query, parseInt(searchView.limit) || this._settings.searchResultsLimit).then((newSearchResults) => {
  ...
  searchCountFence(source, el, ctx) {
    return __async(this, null, function* () {
  ...
  renderSearchResults(el, searchView, searchResults) {
  ...
  renderSearchCount(el, searchResultsCount, query) {
  ...
  renderLoadingItem(item, itemUrl) {
    const tagsRow = createDiv("ji-tags has-addons");
  ...
  renderSearchResultsTable(el, searchView, searchResults) {
  ...
  renderSearchResultsTableBody(table, searchResults, searchView) {
  ...
  renderSearchResultsList(el, searchResults) {
    const list = [];
...
// src/searchWizardModal.ts
var import_obsidian3 = __toModule(require("obsidian"));
var SearchWizardModal = class extends import_obsidian3.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian3.Setting(contentEl).setName("Search rendering type").addDropdown((dropdown) => dropdown.addOptions(SEARCH_RESULTS_RENDERING_TYPE_DESCRIPTION).setValue(this._searchView.type).onChange((value) => __async(this, null, function* () {
      this._searchView.type = value;
    })));
    new import_obsidian3.Setting(contentEl).setName("Jira query").addTextArea((textArea) => textArea.setValue(this._searchView.query).onChange((value) => __async(this, null, function* () {
      this._searchView.query = value;
    })));
    new import_obsidian3.Setting(contentEl).setName("Search results limit").addText((text) => text.setPlaceholder(`Use default value: ${this._settings.searchResultsLimit}`).setValue(this._searchView.limit).onChange((value) => __async(this, null, function* () {
    ...
    new import_obsidian3.Setting(contentEl).setDesc(desc);
    this._searchView.columns.forEach((column, index) => {
      const setting = new import_obsidian3.Setting(contentEl).addDropdown((dropdown) => dropdown.addOptions(SEARCH_COLUMNS_DESCRIPTION).setValue(column.type).onChange((value) => __async(this, null, function* () {
        this._searchView.columns[index].type = value;
        this.open();
      })).selectEl.addClass("flex-grow-1"));
      setting.addExtraButton((button) => button.setIcon(this._searchView.columns[index].compact ? "compress-glyph" : "enlarge-glyph").setTooltip(this._searchView.columns[index].compact ? "Compact" : "Full width").onClick(() => __async(this, null, function* () {
      ...
      setting.addExtraButton((button) => button.setIcon("down-chevron-glyph").setTooltip("Move down").setDisabled(index === this._searchView.columns.length - 1).onClick(() => __async(this, null, function* () {
        const tmp = this._searchView.columns[index];
        this._searchView.columns[index] = this._searchView.columns[index + 1];
        this._searchView.columns[index + 1] = tmp;
        this.open();
    ...
    const searchColumnsButtons = new import_obsidian3.Setting(contentEl);
    searchColumnsButtons.addButton((button) => button.setButtonText("Add Column").setCta().onClick((value) => __async(this, null, function* () {
      this._searchView.columns.push({ type: ESearchColumnsTypes.KEY, compact: false });
      this.open();
    })));
    searchColumnsButtons.addButton((button) => button.setButtonText("Reset to default columns").setWarning().onClick((value) => __async(this, null, function* () {
      this._searchView.columns = [];
      this.open();
    })));
    new import_obsidian3.Setting(contentEl).addButton((btn) => btn.setButtonText("Insert").setCta().onClick(() => {
      this.close();
...
// src/main.ts
var JiraIssuePlugin = class extends import_obsidian4.Plugin {
  onload() {
    return __async(this, null, function* () {
      this._settings = new JiraIssueSettingsTab(this.app, this);
      yield this._settings.loadSettings();
      ...
      this._processor = new JiraIssueProcessor2(this._settings.getData(), this._client, this._cache, this.app.vault);
      ...
      this.addCommand({
        ...
        callback: () => {
          this._cache.clear();
          this._client.updateCustomFieldsCache();
          new import_obsidian4.Notice("JiraIssue: Cache cleaned");
        }
      });
      this.addCommand({
